...
include('conn.php');
$con = conectar();
$sql = "SELECT * FROM produmap WHERE ciudades='nueva imperial'";
...
<head>
	...
	<title>Lugares en Nueva Imperial</title>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-primary bg-light">
		<div class="container-fluid">
			<a class="navbar-brand" href="#">Pupi</a>
	...
	<script>
		var locations = [
			["Supermercado El trebol", -38.74404, -72.95367],
			["Supermercado Acuenta", -38.74175, -72.95219],
			["Supermercado Lily Av anibal pinto", -38.7417, -72.95466],
			["Unimarc", -38.74435, -72.95252],
			["Supermercado lily Av Republica", -38.74962, -72.94657]
		];
		var map = L.map('map').setView([-38.7541, -72.9533], 14);
